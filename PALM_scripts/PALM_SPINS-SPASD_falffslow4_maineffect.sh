...
#SBATCH --output=/projects/sbagheri/PALM_conmat_bothsoccog_falff_main_effect_slow4_%j.txt  # Standard output and error log
...
truncname="$(echo $(basename `echo "$filename"`) | sed 's/filepaths/PALM_conmat_bothsoccog_falff_main_effect_slow4/;s/.txt//')" 
