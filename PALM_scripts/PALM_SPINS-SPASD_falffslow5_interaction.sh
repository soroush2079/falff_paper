...
#SBATCH --output=/projects/sbagheri/PALM_conmat_bothsoccog_falff_interaction_slow5_%j.txt  # Standard output and error log
...
truncname="$(echo $(basename `echo "$filename"`) | sed 's/filepaths/PALM_conmat_combined_falff_with_covariates_interaction_slow5/;s/.txt//')" 
